...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    ...
    else if (request.cmd == 'logwatch') {
        var data = { "category": request.category, "periods": request.periods, "numbers": request.numbers, "times": request.times };
        //console.log(data);
        $.ajax({
